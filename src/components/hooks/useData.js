...
const dataFormatOptions = { year: 'numeric', month: 'long', day: 'numeric' };
...
const initialState = {
  let diet = {
     ...
     data_points: [
         {
             //today's date
             date: currentDate.toLocaleDateString('en-AU', dataFormatOptions),
             //empty, let user do the input
             intake_list: [] 
         },
         {
             //yesterday's date
             date: currentDate.setDate(currentDate.getDate() - 1).toLocaleDateString('en-AU', dataFormatOptions),
             intake_list: [
                 {
         ...
         {
             //2 days ago
             date: currentDate.setDate(currentDate.getDate() - 2).toLocaleDateString('en-AU', dataFormatOptions),
             intake_list: [
                 {
